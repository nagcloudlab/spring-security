...
public class SpringSecurityUserContext implements UserContext {
	...
	/**
	 * Sets the {@link CalendarUser} as the current {@link Authentication}'s
	 * principal. It uses
	 */
	@Override
	public void setCurrentUser(CalendarUser user) {
		...
		SecurityContextHolder.getContext().setAuthentication(authentication); // considered as the current user
	}
